...
@InputType()
class AssignmentCreateNestedManyWithoutModuleModelsInput {
...
export { AssignmentCreateNestedManyWithoutModuleModelsInput as AssignmentCreateNestedManyWithoutModuleModelsInput };
